/******/ (() => {
  ...
  \********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const root_component_1 = __webpack_require__(
          /*! ./components/root-component */ "./src/components/root-component.ts"
        );
        const backdrop_1 = __importDefault(
          __webpack_require__(
            /*! ./components/backdrop */ "./src/components/backdrop.ts"
          )
        );
        const time_clock_1 = __importDefault(
          __webpack_require__(
            /*! ./components/time-clock */ "./src/components/time-clock.ts"
          )
        );
        const todoList_1 = __importDefault(
          __webpack_require__(
            /*! ./components/todoList */ "./src/components/todoList.ts"
          )
        );
        ...
        const showButton = new button_1.Button(
          "show-button",
          () => {
            toggleHandler();
  ...
  \************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        Object.defineProperty(exports, "__esModule", { value: true });
        const base_component_1 = __webpack_require__(
  ...
  \**********************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class Button extends base_component_1.DOMTemplate {
          ...
          setActive(isActive) {
            this.element.className = isActive
              ? `${this._unFocusClass} slide-in`
              : "";
          }
        }
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class RootComponent {
          ...
          attach(insertAtBeginning, element) {
            let location = insertAtBeginning ? "afterbegin" : "beforeend";
